...
program tests
  ...
  integer :: stat,lu=0,ni,nj,nk,nkk,fnom,fstouv,fstfrm,fclos,fstlir,fstinf,k,lutxt=69,ip1,ip2
  ...
  nullify(ip1_list,dpidpis_3d,dpidpis_3d_from_prof,dpidpis_3d_8,dpidpis_3d_from_prof_8,p0,px,p0_8,p00,p00_8,coef_b)
...
!$omp parallel private(tid,dpidpis_profil,dpidpis_profil_8,stat,ii,jj,k)
   ...
   do j=1,nj
      do i=1,ni
         ...
         if(dpidpis_3d_from_prof_8(i,j,k).ne.dpidpis_3d_8(i,j,k))then
            print*,'Problem : OpenMP do not reproduce result for reak*8'

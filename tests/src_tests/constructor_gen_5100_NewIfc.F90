...
program constructor
  ...
  use vGrid_Descriptors, only: vgd_levels,vgd_get,vgd_print,VGD_ERROR,vgd_create_from_hyb_5100
  ...
  real(kind=8), target :: ptop
  real(kind=8), pointer :: ptop_p
  real(kind=8) :: pref=100000d0
  logical :: OK=.true.
  integer :: test_5100
  ...
  stat = vgd_create_from_hyb_5100(vgdid,hyb=hyb,rcoef1=rcoef1,rcoef2=rcoef2,rcoef3=rcoef3,rcoef4=rcoef4,pref_8=pref,dhm=10.0,dht=2.0,ptop_out_8=ptop_p,avg_L=.true.)
  ...
  stat = vgd_create_from_hyb_5100(vgdid,hyb=hyb,rcoef1=rcoef1,rcoef2=rcoef2,rcoef3=rcoef3,rcoef4=rcoef4,pref_8=pref,dhm=10.0,dht=2.0,ptop_out_8=ptop_p,avg_L=.false.)
  stat = vgd_print(vgdid)
  ...
  call ut_report(OK,'vgd_create_from_hyb_5100 vertical generate initializer value')

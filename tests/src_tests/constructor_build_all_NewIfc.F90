...
program constructor_build_all_NewIfc
...
end program constructor_build_all_NewIfc
...
integer function check_build(vgdid) result(istat)
  ...
  ! Local varibales
  integer :: check_build_1001_2001_5999, check_build_1002, check_build_4001, check_build_5001, check_build_5002, check_build_5003, check_build_5004, check_build_5005, check_build_5100, check_build_21001, check_build_21002
  integer :: vcode
  ...
  case (5003)
     if(check_build_5003(vgdid) == VGD_ERROR) return
  case (5004)
     if(check_build_5004(vgdid) == VGD_ERROR) return
  case (5005)
...
integer function check_build_1001_2001_5999(vgdid) result(istat)
  ...
  select case(vcode)
  case(1001)
     if( vgd_create_from_ab_1001(vgdid2, &
       ip1=-1,           &
       ip2=-1,           &
       a_m_8=a_m_8,      &
       b_m_8=b_m_8,      &
  ...
  case(2001)
     if( vgd_create_from_ab_2001(vgdid2, &
       ip1=-1,           &
       ip2=-1,           &
       a_m_8=a_m_8,      &
       b_m_8=b_m_8,      &
  ...
  case(5999)
     if( vgd_create_from_ab_5999(vgdid2, &
       ip1=-1,           &
       ip2=-1,           &
       a_m_8=a_m_8,      &
       b_m_8=b_m_8,      &
  ...
  case default
     print*, 'INTERNAL ERROR in check_build_1001_2001_5999'
  end select
...
integer function check_build_1002(vgdid) result(istat)
  ...
  if( vgd_create_from_ab_1002(vgdid2, &
              ip1=-1,           &
              ip2=-1,           &
              ptop_8=ptop_8,    &
              a_m_8=a_m_8,      &
...
integer function check_build_4001(vgdid) result(istat)
  ...
  if( vgd_create_from_ab_4001(vgdid2, &
              ip1=-1,           &
              ip2=-1,           &
              a_m_8=a_m_8,      &
              b_m_8=b_m_8,      &
...
integer function check_build_5001(vgdid) result(istat)
  ...
  if( vgd_create_from_ab_5001(vgdid2, &
              ip1=-1,           &
              ip2=-1,           &
              ptop_8=ptop_8,    &
              pref_8=pref_8,    &
...
integer function check_build_5002(vgdid) result(istat)
  ...
  use Vgrid_Descriptors, only: vgd_new, vgd_get, vgd_print,VGD_LEN_NAME, VGD_ERROR, &
                               VGD_OK, vgd_create_from_ab_5002
  ...
  if( vgd_create_from_ab_5002(vgdid2, &
              ip1=-1,            &
              ip2=-1,            &
              ptop_8=ptop_8,     &
              pref_8=pref_8,     &
...
integer function check_build_5003(vgdid) result(istat)

  use Vgrid_Descriptors, only: vgd_new, vgd_get, vgd_print,VGD_LEN_NAME, VGD_ERROR, &
                               VGD_OK, vgd_create_from_ab_5003
  ...
  if( vgd_create_from_ab_5003(vgdid2, &
              ip1=-1,            &
              ip2=-1,            &
              ptop_8=ptop_8,     &
              pref_8=pref_8,     &
...
integer function check_build_5004(vgdid) result(istat)

  use Vgrid_Descriptors, only: vgd_new, vgd_get, vgd_print,VGD_LEN_NAME, VGD_ERROR, &
                               VGD_OK, vgd_create_from_ab_5004
  ...
  if( vgd_create_from_ab_5004(vgdid2, &
              ip1=-1,            &
              ip2=-1,            &
              ptop_8=ptop_8,     &
              pref_8=pref_8,     &
...
integer function check_build_5005(vgdid) result(istat)
  ...
  if( vgd_create_from_ab_5005(vgdid2, &
              ip1=-1,            &
              ip2=-1,            &
              pref_8=pref_8,     &
              rcoef1=rcoef1,     &
...
integer function check_build_5100(vgdid) result(istat)
  ...
  if( vgd_create_from_ab_5100(vgdid2, &
              ip1=-1,            &
              ip2=-1,            &
              pref_8=pref_8,     &
              rcoef1=rcoef1,     &
...
integer function check_build_21001(vgdid) result(istat)
  ...
  if( vgd_create_from_ab_21001(vgdid2, &
              ip1=-1,            &
              ip2=-1,            &
              rcoef1=rcoef1,     &
              rcoef2=rcoef2,     &
...
integer function check_build_21002(vgdid) result(istat)
  ...
  if( vgd_create_from_ab_21002(vgdid2, &
              ip1=-1,            &
              ip2=-1,            &
              rcoef1=rcoef1,     &
              rcoef2=rcoef2,     &

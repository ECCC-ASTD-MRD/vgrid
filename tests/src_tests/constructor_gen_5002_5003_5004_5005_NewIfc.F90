...
if(.false.)then
  ...
  call flush(6)
  stat = vgd_create_from_hyb_5002(vgdid,hyb=hyb,rcoef1=rcoef1,rcoef2=rcoef2,ptop_8=0.d0,pref_8=pref)
  if(stat.ne.VGD_ERROR)OK=.false.  
  stat = vgd_create_from_hyb_5002(vgdid,hyb=hyb,rcoef1=rcoef1,rcoef2=rcoef2,ptop_8=-1.d0,pref_8=pref)
  if(stat.ne.VGD_ERROR)OK=.false.  
  stat = vgd_create_from_hyb_5002(vgdid,hyb=hyb,rcoef1=rcoef1,rcoef2=rcoef2,ptop_8=-2.d0,pref_8=pref)
  if(stat.ne.VGD_ERROR)OK=.false.  
  print*,'The following 3 errors on hyb values are normal'
  call flush(6)
  stat = vgd_create_from_hyb_5002(vgdid,hyb=hyb_wrong1,rcoef1=rcoef1,rcoef2=rcoef2,ptop_8=ptop,pref_8=pref)
  stat = vgd_create_from_hyb_5002(vgdid,hyb=hyb_wrong2,rcoef1=rcoef1,rcoef2=rcoef2,ptop_8=ptop,pref_8=pref)
  stat = vgd_create_from_hyb_5002(vgdid,hyb=hyb_wrong3,rcoef1=rcoef1,rcoef2=rcoef2,ptop_8=ptop,pref_8=pref)
  ...
  stat = vgd_create_from_hyb_5002(vgdid,hyb=hyb,rcoef1=rcoef1,rcoef2=rcoef2,ptop_8=ptop,pref_8=pref,ip1=0)

...
program tests
  use vGrid_Descriptors, only: vgd_new,vgd_levels,VGD_OK
  ...
  nullify(ip1_list, pres_profil, p0, px)
  ...
  open(unit=lutxt,file='data/dm_5003_ips.txt',status='OLD')
  read(lutxt,*) ip1,ip2
  close(lutxt)
  ...
  ip1_list=(/95294347,95327133,95351970,95364885,93423264/)

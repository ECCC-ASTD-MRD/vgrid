...
int check_gen_1001_2001_4001(vgrid *my_vgrid, int vcode){
  ...
  if( c_create_from_hyb(&my_vgrid2, kind, version, hyb, nk, NULL, NULL, NULL, NULL, NULL,
  ...
  switch(vcode) {
  case 1001:
    if( c_create_from_hyb_1001(&my_vgrid2, hyb, nk, 0, 0) == VGD_ERROR) {
      return(VGD_ERROR);
    }
    break;
  case 2001:
    if( c_create_from_hyb_2001(&my_vgrid2, hyb, nk, 0, 0) == VGD_ERROR) {
      return(VGD_ERROR);
    }
    break;
  case 4001:
    if( c_create_from_hyb_4001(&my_vgrid2, hyb, nk, 0, 0) == VGD_ERROR) {
      return(VGD_ERROR);
    }
    break;
  default:
...
int check_gen_1002(vgrid *my_vgrid){
  ...
  printf("  Testing generic interface\n");
  if( c_create_from_hyb(&my_vgrid2, kind, version, hyb, nk, NULL, NULL, &ptop_8, NULL, NULL,
  ...
  free(my_vgrid2);
  my_vgrid2 = nullptr;
  if( c_create_from_hyb_1002(&my_vgrid2, hyb, nk, ptop_8, 0, 0) == VGD_ERROR) {
    return(VGD_ERROR);
  }
  //Test equality
  ier = my_vgrid->Cvgd_vgdcmp(my_vgrid2);
...
int check_gen_5001(vgrid *my_vgrid){
  ...
  printf("  Testing generic interface\n");
  if( c_create_from_hyb(&my_vgrid2, kind, version, hyb, nk, &rc_1, NULL,
  ...
  free(my_vgrid2);
  my_vgrid2 = nullptr;
  if( c_create_from_hyb_5001(&my_vgrid2, hyb, nk, ptop_8, pref_8, rc_1, 0, 0) == VGD_ERROR) {
    return(VGD_ERROR);
  }
  //Test equality
  ier = my_vgrid->Cvgd_vgdcmp(my_vgrid2);
...
int check_gen_5002(vgrid *my_vgrid){
  ...
  printf("  Testing generic interface\n");
  if( c_create_from_hyb(&my_vgrid2, kind, version, hyb, nk, &rc_1, &rc_2,
		   &ptop_8, &pref_8, NULL,0, 0, NULL, NULL, 0) == VGD_ERROR ) {
    printf("ERROR: check_gen_5002, problem with c_create_from_hyb\n");
    return(VGD_ERROR);
  }
  // Test equality
  ier = my_vgrid->Cvgd_vgdcmp(my_vgrid2);
  ...
  free(my_vgrid2);
  my_vgrid2 = nullptr;
  if( c_create_from_hyb_5002(&my_vgrid2, hyb, nk, ptop_8, pref_8, rc_1, rc_2, 0, 0) == VGD_ERROR) {
    return(VGD_ERROR);
  }
  //Test equality
  ier = my_vgrid->Cvgd_vgdcmp(my_vgrid2);
...
int check_gen_5005(vgrid *my_vgrid){
  ...
  free(my_vgrid2);
  my_vgrid2 = nullptr;
  if( c_create_from_hyb_5005(&my_vgrid2, hyb, nk, pref_8, &ptop_out_8, rc_1, rc_2, 0, 0, &dhm, &dht) == VGD_ERROR) {
    return(VGD_ERROR);
  }
  //Test equality
  ier = my_vgrid->Cvgd_vgdcmp(my_vgrid2);
...
int check_gen_5100(vgrid *my_vgrid){
  ...
  printf("  Testing specific interface\n");
  if( c_create_from_hyb_5100(&my_vgrid2, hyb, nk, pref_8, &ptop_out_8, rc_1, rc_2, rc_3, rc_4, 0, 0, &dhm, &dht, 1) == VGD_ERROR) {
    return(VGD_ERROR);
  }
  //Test equality
  ier = my_vgrid->Cvgd_vgdcmp(my_vgrid2);

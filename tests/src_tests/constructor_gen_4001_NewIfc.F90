...
program constructor
  ...
  use vGrid_Descriptors, only: vgd_get,vgd_write,VGD_ERROR,vgd_create_from_hyb_4001
  ...
  if( vgd_create_from_hyb_4001(vgdid,hyb=hgts) == VGD_ERROR)call exit(1)
  ...
  stat = vgd_create_from_hyb_4001(vgdid,hyb=-hgts)
  ...
  stat = vgd_create_from_hyb_4001(vgdid,hyb=hgts2)
  if(stat.ne.VGD_ERROR)OK=.false.
  ...
  call ut_report(OK,'vgd_create_from_hyb_4001 vertical generate initializer value')

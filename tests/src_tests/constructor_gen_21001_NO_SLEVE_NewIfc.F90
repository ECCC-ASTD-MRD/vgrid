...
program constructor
  ...
  use vGrid_Descriptors, only: vgd_get,vgd_print,VGD_ERROR,vgd_create_from_hyb_21001
...
(/ 6.62078E+04, 6.29395E+04, 5.95406E+04, 5.60645E+04, 5.26367E+04, 4.93408E+04, 4.63244E+04, 4.35656E+04, 4.10827E+04, 3.88781E+04,&
 ...
 1.43746E+03, 1.22341E+03, 1.02339E+03, 8.36754E+02, 6.73131E+02, 5.21595E+02, 3.81767E+02, 2.53260E+02, 1.45511E+02, 4.83247E+01/)
  ...
  real :: rcoef1=4.,rcoef2=30.,rcoef3=-1.,rcoef4=-1.
  ...
  if( vgd_create_from_hyb_21001(vgdid1,hyb=hgts,rcoef1=rcoef1,rcoef2=rcoef2,dhm=10.0,dht=1.5) == VGD_ERROR )OK=.false.
  
  ! Construct a new set of vertical coordinate descriptors 21001 Gal-Chen
  ! Put rcoef3 and rcoef4 but set to -1
  if( vgd_create_from_hyb_21001(vgdid2,hyb=hgts,rcoef1=rcoef1,rcoef2=rcoef2,rcoef3=rcoef3,rcoef4=rcoef4,dhm=10.0,dht=1.5) == VGD_ERROR )OK=.false.
  ...
  call ut_report(OK,'vgd_create_from_hyb_21001 vertical generate initializer SLEVE like coordinate')
...
integer function test_hgts(vgdid,F_file,F_write_control_L) result(istat)
   ...
   real(kind=8), dimension(:), pointer :: b_m_8,a_m_8,c_m_8,b_t_8,a_t_8,c_t_8,work_8

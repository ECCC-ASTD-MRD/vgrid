...
int check_build_1001_2001_5999_4001(vgrid *my_vgrid, int vcode){
  ...
  if( c_create_from_ab(&my_vgrid2, kind, version, nk, -1, -1, NULL, NULL, NULL, NULL,
  ...
  switch(vcode) {
  case 1001:
    if( c_create_from_ab_1001(&my_vgrid2, -1, -1, a_m_8, b_m_8, ip1_m, nk) == VGD_ERROR) {
      return(VGD_ERROR);
    }
    break;
  case 2001:
    if( c_create_from_ab_2001(&my_vgrid2, -1, -1, a_m_8, b_m_8, ip1_m, nk) == VGD_ERROR) {
      return(VGD_ERROR);
    }
    break;
  case 4001:
    if( c_create_from_ab_4001(&my_vgrid2, -1, -1, a_m_8, b_m_8, ip1_m, nk) == VGD_ERROR) {
      return(VGD_ERROR);
    }
    break;
  case 5999:
    if( c_create_from_ab_5999(&my_vgrid2, -1, -1, a_m_8, b_m_8, ip1_m, nk) == VGD_ERROR) {
      return(VGD_ERROR);
    }
    break;
  default:
...
int check_build_1002(vgrid *my_vgrid){
  ...
  printf("  Testing generic interface\n");
  if( c_create_from_ab(&my_vgrid2, kind, version, nk, -1, -1, &ptop_8, NULL, NULL, NULL,
  			  a_m_8, b_m_8, NULL, NULL, ip1_m, NULL, nk, 0) == VGD_ERROR) {
    return(VGD_ERROR);
  }
  // Test equality
  ...
  free(my_vgrid2);
  my_vgrid2 = nullptr;
  if( c_create_from_ab_1002(&my_vgrid2, -1, -1, ptop_8, a_m_8, b_m_8, ip1_m, nk) == VGD_ERROR) {
    return(VGD_ERROR);
  }
  ier = my_vgrid->Cvgd_vgdcmp(my_vgrid2);
  if( ier != 0 ){
...
int check_build_5001(vgrid *my_vgrid){
  ...
  printf("  Testing generic interface\n");
  if( c_create_from_ab(&my_vgrid2, kind, version, nk, -1, -1, &ptop_8, &pref_8, &rc_1, NULL,
  			  a_m_8, b_m_8, NULL, NULL, ip1_m, NULL, nk, 0) == VGD_ERROR) {
    return(VGD_ERROR);
  }
  // Test equality
  ...
  free(my_vgrid2);
  my_vgrid2 = nullptr;
  if( c_create_from_ab_5001(&my_vgrid2, -1, -1, ptop_8, pref_8, rc_1, a_m_8, b_m_8, ip1_m, nk) == VGD_ERROR) {
    return(VGD_ERROR);
  }
  // Test equality
  ier = my_vgrid->Cvgd_vgdcmp(my_vgrid2);
...
int check_build_5002(vgrid *my_vgrid){
  ...
  printf("  Testing generic interface\n");
  if( c_create_from_ab(&my_vgrid2, kind, version, 0, -1, -1, &ptop_8, &pref_8, &rc_1, &rc_2,
  ...
  free(my_vgrid2);
  my_vgrid2 = nullptr;
  if( c_create_from_ab_5002(&my_vgrid2, -1, -1, ptop_8, pref_8, rc_1, rc_2,
...
int check_build_5005(vgrid *my_vgrid){
  ...
  printf("  Testing generic interface\n");
  if( c_create_from_ab(&my_vgrid2, kind, version, -1, -1, -1, NULL, &pref_8, &rc_1, &rc_2,
  ...
  free(my_vgrid2);
  my_vgrid2 = nullptr;
  if( c_create_from_ab_5005(&my_vgrid2, -1, -1, pref_8, rc_1, rc_2,
...
int check_build_5100(vgrid *my_vgrid){
  ...
  printf("  Testing specific interface\n");
  if( c_create_from_ab_5100(&my_vgrid2, -1, -1, pref_8, rc_1, rc_2, rc_3, rc_4,
...
int check_build_21001(vgrid *my_vgrid){
  ...
  printf("  Testing specific interface\n");
  if( c_create_from_ab_21001(&my_vgrid2, -1, -1, rc_1, rc_2, rc_3, rc_4,
...
int check_build_21002(vgrid *my_vgrid){
  ...
  // No generic interface for 21001
  printf("  Testing specific interface\n");
  if( c_create_from_ab_21002(&my_vgrid2, -1, -1, rc_1, rc_2, rc_3, rc_4,

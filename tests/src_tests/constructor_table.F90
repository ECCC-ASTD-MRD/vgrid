...
program constructor
   ...
   implicit none
   integer, parameter :: nversion=8
   integer stat,i,test_it
   logical :: OK=.true.
   character(len=10), dimension(nversion) :: vcode_S=(/"5002","5003","5004","5005","5100","5999","21001","21001"/)
   character(len=60), dimension(nversion) :: suffix_S=(/""   ,""    ,""    ,""    ,""    ,""    ,"_SLEVE","_NON_SLEVE"/)

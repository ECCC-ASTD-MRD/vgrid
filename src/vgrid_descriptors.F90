...
module vGrid_Descriptors
   ...
   public :: vgd_create_from_hyb_1002            !class constructor
   public :: vgd_create_from_hyb_1003            !class constructor
   public :: vgd_create_from_hyb_2001            !class constructor
   ...
   public :: vgd_create_from_hyb_5005            !class constructor
   public :: vgd_create_from_hyb_5100            !class constructor
...
#include "vgrid_descriptors.hf"
   ...
   interface
      ...
      integer(c_int) function f_create_from_hyb_1002(vgdid, hyb, size_hyb, &
         ...
         real (c_double), value :: ptop_8
         integer (c_int), value :: ip1, ip2
      end function f_create_from_hyb_1002
      ...
      integer(c_int) function f_create_from_hyb_5002(vgdid, hyb, size_hyb, &
         ...
         integer (c_int), value :: ip1, ip2
         real (c_float),  value :: rcoef1, rcoef2
      end function f_create_from_hyb_5002
      ...
      integer(c_int) function f_create_from_hyb_5003(vgdid, hyb, size_hyb, &
         ...
         integer (c_int), value :: ip1, ip2
         real (c_float),  value :: rcoef1, rcoef2
      end function f_create_from_hyb_5003
      ...
      integer(c_int) function f_create_from_hyb_5004(vgdid, hyb, size_hyb, &
         ...
         integer (c_int), value :: ip1, ip2
         real (c_float),  value :: rcoef1, rcoef2
      end function f_create_from_hyb_5004
      ...
      integer(c_int) function f_create_from_hyb_5005(vgdid, hyb, size_hyb, &
         ...
         integer (c_int), value :: size_hyb
         real (c_double), value :: pref_8
         type(c_ptr),     value :: ptop_out_8
         integer (c_int), value :: ip1, ip2
         real (c_float),  value :: rcoef1, rcoef2
      end function f_create_from_hyb_5005
      ...
      integer(c_int) function f_create_from_hyb_5100(vgdid, hyb, size_hyb, &
         ...
         real (c_float),  value :: rcoef1, rcoef2, rcoef3, rcoef4
      end function f_create_from_hyb_5100
...
contains
   ...
   integer function vgd_create_from_hyb_1001(vgdid, hyb, ip1, ip2) result(status)
    ...
    integer function vgd_create_from_hyb_1002(vgdid, hyb, ptop_8, ip1, ip2) result(status)
      integer, target :: vgdid
      ...
      if( f_create_from_hyb_1002(vgdid_p, hyb_p, size(hyb), &
                                 ptop_8, l_ip1, l_ip2 &
                                )== VGD_ERROR )then
        print*,'(F_vgd) ERROR: In vgd_create_from_hyb_1002'
        return
      end if

      status = VGD_OK
      return
    end function vgd_create_from_hyb_1002

    integer function vgd_create_from_hyb_1003(vgdid, hyb, ptop_8, pref_8, &
                          rcoef1, ip1, ip2) &
                          result(status)
      integer, target :: vgdid
      real, target, dimension(:),intent(in) :: hyb
      ...
      if( f_create_from_hyb_1003(vgdid_p, hyb_p, size(hyb), &
                                 ptop_8, pref_8, rcoef1, l_ip1, l_ip2 &
                                )== VGD_ERROR )then
        print*,'(F_vgd) ERROR: In vgd_create_from_hyb_1003'
        return
      end if

      status = VGD_OK
      return
    end function vgd_create_from_hyb_1003

   integer function vgd_create_from_hyb_2001(vgdid, hyb, ip1, ip2) result(status)
      implicit none
      ...
      vgdid_p=c_loc(vgdid)
      hyb_CP = c_loc(hyb)
      if(f_create_from_hyb_2001(vgdid_p, hyb_CP, size(hyb),l_ip1, l_ip2) &
                               == VGD_ERROR)then
         print*,'(F_vgd) ERROR in vgd_create_from_hyb_2001, problem with f_create_from_hyb'
         return
      endif
      status = VGD_OK
    end function vgd_create_from_hyb_2001

   integer function vgd_create_from_hyb_4001(vgdid, hyb, ip1, ip2) result(status)
      implicit none
      ...
      vgdid_p=c_loc(vgdid)
      hyb_CP = c_loc(hyb)
      if(f_create_from_hyb_4001(vgdid_p, hyb_CP, size(hyb),l_ip1, l_ip2) &
                               == VGD_ERROR)then
         print*,'(F_vgd) ERROR in vgd_create_from_hyb_4001, problem with f_create_from_hyb'
         return
      endif
      status = VGD_OK
    ...
    integer function vgd_create_from_hyb_5002(vgdid, hyb, ptop_8, pref_8, &
      ...
      if( f_create_from_hyb_5002(vgdid_p, hyb_p, size(hyb), &
                                 ptop_8, pref_8, rcoef1, rcoef2, l_ip1, l_ip2 &
                                )== VGD_ERROR )then
        print*,'(F_vgd) ERROR: In vgd_create_from_hyb_5002'
        return
      end if

      status = VGD_OK
      return
    end function vgd_create_from_hyb_5002

    integer function vgd_create_from_hyb_5003(vgdid, hyb, ptop_8, pref_8, &
                          rcoef1, rcoef2, ip1, ip2) &
                          result(status)
      integer, target :: vgdid
      real, target, dimension(:),intent(in) :: hyb
      ...
      if( f_create_from_hyb_5003(vgdid_p, hyb_p, size(hyb), &
                                 ptop_8, pref_8, rcoef1, rcoef2, l_ip1, l_ip2 &
                                )== VGD_ERROR )then
        print*,'(F_vgd) ERROR: In vgd_create_from_hyb_5003'
        return
      end if

      status = VGD_OK
      return
    end function vgd_create_from_hyb_5003

    integer function vgd_create_from_hyb_5004(vgdid, hyb, ptop_8, pref_8, &
                          rcoef1, rcoef2, ip1, ip2) &
                          result(status)
      integer, target :: vgdid
      real, target, dimension(:),intent(in) :: hyb
      ...
      if( f_create_from_hyb_5004(vgdid_p, hyb_p, size(hyb), &
                                 ptop_8, pref_8, rcoef1, rcoef2, l_ip1, l_ip2 &
                                )== VGD_ERROR )then
        print*,'(F_vgd) ERROR: In vgd_create_from_hyb_5004'
        return
      end if

      status = VGD_OK
      return
    end function vgd_create_from_hyb_5004

    integer function vgd_create_from_hyb_5005(vgdid, hyb, pref_8, ptop_out_8, &
                          rcoef1, rcoef2, ip1, ip2, dhm, dht) &
                          result(status)
      integer, target :: vgdid
      real, target, dimension(:),intent(in) :: hyb
      real(kind=8) :: pref_8
      real(kind=8), pointer :: ptop_out_8
      real :: rcoef1, rcoef2, dhm, dht
      integer, optional, intent(in) :: ip1, ip2

      integer l_ip1,l_ip2
      type(c_ptr) :: vgdid_p, hyb_p, ptop_out_8_p, dhm_p, dht_p
      ...
      if( f_create_from_hyb_5005(vgdid_p, hyb_p, size(hyb), &
                                 pref_8, ptop_out_8_p, &
                                 rcoef1, rcoef2, l_ip1, l_ip2, &
                                 dhm_p, dht_p)== VGD_ERROR &
                                )then
        print*,'(F_vgd) ERROR: In vgd_create_from_hyb_5005'
        return
      end if

      status = VGD_OK
      return
    end function vgd_create_from_hyb_5005

    integer function vgd_create_from_hyb_5100(vgdid, hyb, pref_8, ptop_out_8, &
                          rcoef1, rcoef2, rcoef3, rcoef4, ip1, ip2, dhm, dht, avg_l) &
                          result(status)
      integer, target :: vgdid
      real, target, dimension(:),intent(in) :: hyb
      real(kind=8) :: pref_8
      real(kind=8), pointer :: ptop_out_8
      real :: rcoef1, rcoef2, rcoef3, rcoef4, dhm, dht
      integer, optional, intent(in) :: ip1, ip2
      logical, optional, intent(in) :: avg_l

      integer l_ip1,l_ip2, my_avg
      type(c_ptr) :: vgdid_p, hyb_p, ptop_out_8_p, dhm_p, dht_p
      ...
      if( f_create_from_hyb_5100(vgdid_p, hyb_p, size(hyb), &
                                 pref_8, ptop_out_8_p, &
                                 rcoef1, rcoef2, rcoef3, rcoef4, l_ip1, l_ip2, &
                                 dhm_p, dht_p, my_avg)== VGD_ERROR &
                                )then
        print*,'(F_vgd) ERROR: In vgd_create_from_hyb_5100'
        return
      end if

      status = VGD_OK
      return
    end function vgd_create_from_hyb_5100
